    ...
    <div class="my-4 space-y-4 pl-6 pr-10 md:my-0">
        ...
        <div class="flex items-center space-x-5">
            <img alt="{{ $article->user->name }}"
                class="avatar h-20 w-20 rounded-full object-cover ring ring-offset-2 ring-offset-base-100"
    ...
    <div class="pl-6 pr-10">
        ...
        <div class="mt-4 space-y-2">
            ...
            <div class="flex items-center space-x-1">
                ...
                <svg class="icon icon-tabler icon-tabler-circle-chevrons-right" fill="none" height="24"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor"
                ...
                @else
                <svg class="icon icon-tabler icon-tabler-chevrons-right" fill="none" height="18" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" width="18"
...
<div>
    ...
    <article
        ...
        <div class="mt-4 flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
            <div class="flex items-center space-x-1">
                <svg class="icon icon-tabler icon-tabler-calendar-time" fill="none" height="20" stroke-linecap="round"
