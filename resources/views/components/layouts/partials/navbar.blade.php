    ...
    <div class="container navbar mx-auto">
            ...
            <ul class="menu menu-horizontal px-1">
                <li>
                    <a href="{{ route('article.list') }}" wire:navigate>
                        <svg class="icon icon-tabler icon-tabler-article" fill="none" height="24" stroke-linecap="round"
                ...
                <li>
                    <a href="{{ route('series.list') }}" wire:navigate>
                        <svg class="icon icon-tabler icon-tabler-books" fill="none" height="24" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"
                            width="24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0h24v24H0z" fill="none" stroke="none"></path>
                ...
                <li>
                    <a href="{{ route('snippet.list') }}" wire:navigate>
                        <svg class="icon icon-tabler icon-tabler-code" fill="none" height="24" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"
                            width="24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0h24v24H0z" fill="none" stroke="none"></path>
        ...
        {{-- <div class="navbar-end">
            <a class="btn btn-sm" href="https://tiktok.com/@kawankoding" target="_blank">
                <svg class="icon icon-tabler icon-tabler-brand-tiktok" fill="none" height="24" stroke-linecap="round"
